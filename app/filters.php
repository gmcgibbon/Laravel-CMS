...
/*
| Permalink slug filter
| 
| Filters permalink input to slug safe string
*/

Route::filter('permalink.slugify', function()
{
	if (Input::has('permalink'))
	{
		Input::merge(['permalink' => Str::slug(Input::get('permalink'))]);
	}
});
